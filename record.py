...
# Pre button
buttonPre = Button(bottomframe2, text="Previous", width=15, height=1, 
                                relief='solid', fg='black', bg="#00ff00", command=pre_sen)
buttonPre['font'] = font
buttonPre.pack(side='left', padx=3)

# Record button
buttonRec = Button(bottomframe1, text="Record", width=15, height=1, 
                                relief='solid', fg='black', bg="#008080", command=record)
buttonRec['font'] = font
buttonRec.pack(side='left', padx=3)

#Stop button
buttonStop = Button(bottomframe1, text="Stop", width=15, height=1, 
                                    relief='solid', fg='black', bg="#c0c0c0", command=stop)
buttonStop['font'] = font

# Next button
buttonNext = Button(bottomframe2, text="Next", width=15, height=1, 
                                relief='solid', fg='black', bg="#00ff00", command=next_sen)
